  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO
        ...
        description="Distribuidor B2B de limpieza, higiene y sanitización en Costa Rica. Marcas líderes como Diversey y TORK, con acompañamiento técnico y entrega propia desde 2007."
        path="/"
